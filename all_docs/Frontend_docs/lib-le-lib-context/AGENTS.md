...
| [docs/backend-plan.md](docs/backend-plan.md) | Phase-by-phase NestJS build plan, with checkboxes |
| [docs/frontend-plan.md](docs/frontend-plan.md) | Phase-by-phase Expo client build plan, with checkboxes |
